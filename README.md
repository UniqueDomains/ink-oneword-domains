...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C532%20rows-8250df">
...
**Public extract:** 7,532 rows · **Live catalog:** 7,532 domains
...
- `ink.csv` — public CSV extract (7,532 rows)
- `ink.json` — public JSON extract (7,532 rows)
...
| alpha.ink      | premium   | $312.50   | $312.50       | 90             | 54     | 5      | name.com                                     |
...
| ----------------------- | ------------------------------------------------ |
| 7,532-row public sample | 7,532 live domains                               |
...
> Unique Domains. *Available .INK One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
